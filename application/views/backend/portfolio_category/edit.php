...
<br>
			<div class="formBox">
				<form action="<?php echo base_url();?>portfolio/category/update/<?php echo $category[0]['id']?>" method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="inputBox focus">
									...
									<input type="text" name="name" class="input" value="<?php echo $category[0]['name']?>">
