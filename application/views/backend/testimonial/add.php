...
<div class="container-fluid" >
    ...
    <!-- Page Heading -->
       ...
       <a href="<?php echo base_url();?>testimonial" class="btn btn-info float-right"><i class="fas fa-list"></i> Testimonial List</a>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="inputBox">
									...
									<textarea class="input" name="testimonial_text"></textarea>
