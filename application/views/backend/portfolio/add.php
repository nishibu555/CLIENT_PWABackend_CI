			...
			<div class="formBox">
				<form action="<?php echo base_url();?>portfolio/save" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="inputBox ">
									<div class="inputText">Portfolio title</div>
							...
							<div class="col-sm-6">
								<div class="inputBox">
									<div class="inputText">Website Link</div>
									<input type="tel" name="website" class="input">
...
<!-- 							<div class="col-sm-6">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="inputBox">
									<div class="inputText">Technology Used</div>
									<textarea class="input" name="technology"></textarea>
